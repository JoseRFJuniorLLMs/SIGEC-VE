...
# *** MUDANÇA AQUI: Removido 'CallError' da importação. ***
...
async def send_ocpp_command(charge_point_id: str, command_name: str, **kwargs) -> dict:
    ...
    try:
        ...
        if command_name == "RemoteStartTransaction":
            ...
            payload = ocpp_call_v201.RemoteStartTransactionPayload(
                ...
                evse_id=connector_id  # Em 2.0.1 é evse_id, não connector_id diretamente no payload
            )
    ...
    except ProtocolError as e:  # *** MUDANÇA AQUI: Capturando ProtocolError em vez de CallError ***
